...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { amt_borrowed: @rate.amt_borrowed, house_id: @rate.house_id, name: @rate.name, rate: @rate.rate, user_id: @rate.user_id }
    end
  ...
  test "should update rate" do
    put :update, id: @rate, rate: { amt_borrowed: @rate.amt_borrowed, house_id: @rate.house_id, name: @rate.name, rate: @rate.rate, user_id: @rate.user_id }
    assert_redirected_to rate_path(assigns(:rate))
  end
